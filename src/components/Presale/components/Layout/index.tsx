    ...
    return (
      <PreRootContainer >
          ...
          <div style={{ height: "75px", background: "#f2f2f2", border: "0px solid black", display: "flex", justifyContent: "space-between" }}>  
            ...
            <div style={{ border: "0px solid black", height: "100%", width: "25%", display: "flex"}}>

                {/* <Box style={{border: "0px solid black", width: "40%", display: "flex", justifyContent: "center", alignSelf: "center", textAlign: "center",
                            borderRadius: "5px", fontSize:"14px", fontWeight: 700, background: "#fff", height:  "38px" }}>
                  Nectwork
                </Box> */}
